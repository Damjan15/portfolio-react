...
const IntroBox = () => {
  return <Box>
      <VStack alignItems="flex-start"  spacing={4}>
          ...
          <Text fontSize="23px">I’m a full stack developer, and cyber security enthusiast. I’m born and raised in Macedonia. I finished my academy for Front-End Development in 2020, and I had a chance to learn back-end technologies and work with them on my first job. </Text>
